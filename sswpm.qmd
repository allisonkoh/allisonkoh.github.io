...
_Optional add-on_: For both courses, please have a short `R` data analysis script from your own work on hand to practice using functional programming and Python "in the wild" (if time). 
